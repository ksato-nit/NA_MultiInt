...
double weight(int n, int k){
    ...
    s += (187 / 96.0) * pow(u, 4) + (295 / 256.0) * pow(u, 2) + (151 / 160.0) * pow(u, 6) + (153 / 1024.0);
    s += ( (-119 / 768.0) * pow(u, 3) - (35 / 384.0) * pow(u, 5) - (65 / 1024.0) * u ) * pow(a, -1);
    s += ( (5 / 512.0) + (7 / 384.0) * pow(u, 4) + (15 / 512.0) * pow(u, 2) ) * pow(a, -2);
    s += ( (1 / 512.0) * pow(u, 3) - (13 / 1536.0) * u ) * pow(a, -3);
    s += ( (-7 / 384.0) * pow(u, 2) + (53 / 3072.0) ) * pow(a, -4);
    s += ( (3749 / 15360.0) * u) * pow(a, -5);
    s += ( -1125 / 1024.0 ) * pow(a, -6);
